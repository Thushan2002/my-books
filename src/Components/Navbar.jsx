...
const Navbar = () => {
  ...
  return (
    <nav className="sticky top-0 z-50 bg-gray-900/95 backdrop-blur-2xl border-b border-gray-800 shadow-[0_0_60px_-15px_rgba(96,165,250,.3)]">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex min-h-[4rem] md:min-h-[5rem] items-center justify-between flex-wrap gap-y-3 gap-x-4 py-2">
          ...
          <div
            ...
            <div className="bggray900/80 backdrop-blur-sm rounded-b-xl p-2">
              <h1 className="text-lg md:text-2xl font-bold bg-gradient-to-r from-cyan-400 via-blue-400 to-purple-400 bg-clip-text text-transparent animate-text-shine">
                ...
                <a
                  href="/"
                  className="ml-1 md:ml-2 text-shadow-[0_0_10px_rgba(96,165,250,.3)]">
                  My Books
                </a>
              </h1>
            </div>
              ...
              <div className="relative group">
                ...
                <div className="relative dynamic-gradient">
                  ...
                  <input
                    ...
                    className="block w-full rounded-2xl border border-gray-700/50 bg-gray-900/60 py-2 md:py-3 pl-10 md:pl-12 pr-4 md:pr-6 text-sm md:text-base text-gray-100 placeholder-gray-400 focus:outline-none focus:border-cyan-300/50 focus:ring focus:ring-cyan-300/30 backdrop-blur-xl shadow-xl transition-all duration-300 hover:bg-gray-900/80"
                  />
                </div>
              </div>
            </form>
